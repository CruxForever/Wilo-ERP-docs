...
1. Откройте отчёт:
   ...
   - либо через интерфейс: «Склад» → «Отчёты по складу» → «Ведомость по товарам в ценах номенклатуры».
![Настройки отчёта Ведомость по товарам на складах](1img/1C_report_WH.png)

2. Установите нужный период и выберите поля, как на скриншоте, и сформируйте отчёт.

![Настройки отчёта Ведомость по товарам на складах](1img/1C_report_WH_2.png)
