...
<div class='cc-container'>
  <div class='cc-parent'>
    ...
    <div>RU1SVTR — Service Area Turkey</div>
  </div>
  <div>
    <h2>Дочерние элементы</h2>
<div class='cc-children'><div class='cc-tile cc-tile-leaf'><div class='cc-tag'>GROUP</div><div>RU1SVZA — South Africa</div></div></div>
  </div>
</div>
